...
public class MultiQueryIT extends SQLIntegTestCase {
  ...
  @Test
  public void minusCMinusTNonExistentFieldOneFieldWithScrollingAndOptimization()
      throws IOException {
    innerMinusCMinusTNonExistentFieldOneField(
  ...
  @Test
  public void minusTMinusCNonExistentFieldFirstQueryWithScrollingAndOptimization()
      throws IOException {
    innerMinusTMinusCNonExistentFieldFirstQuery(
        MINUS_SCROLL_DEFAULT_HINT + MINUS_TERMS_OPTIMIZATION_HINT);
  }
