...
public interface OpenDistroSqlParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code functionAsAggregatorFunctionCall}
	 * labeled alternative in {@link OpenDistroSqlParser#aggregateFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionAsAggregatorFunctionCall(OpenDistroSqlParser.FunctionAsAggregatorFunctionCallContext ctx);
	/**
	 * Visit a parse tree produced by the {@code aggregateWindowedFunctionCall}
	 * labeled alternative in {@link OpenDistroSqlParser#aggregateFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAggregateWindowedFunctionCall(OpenDistroSqlParser.AggregateWindowedFunctionCallContext ctx);
	/**
	 * Visit a parse tree produced by the {@code nestedFunctionCall}
	 * labeled alternative in {@link OpenDistroSqlParser#scalarFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNestedFunctionCall(OpenDistroSqlParser.NestedFunctionCallContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code aggregationAsArgFunctionCall}
	 * labeled alternative in {@link OpenDistroSqlParser#functionCall}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAggregationAsArgFunctionCall(OpenDistroSqlParser.AggregationAsArgFunctionCallContext ctx);
	/**
	 * Visit a parse tree produced by the {@code scalarFunctionsCall}
	 * labeled alternative in {@link OpenDistroSqlParser#functionCall}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitScalarFunctionsCall(OpenDistroSqlParser.ScalarFunctionsCallContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link OpenDistroSqlParser#functionAsAggregatorFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunctionAsAggregatorFunction(OpenDistroSqlParser.FunctionAsAggregatorFunctionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link OpenDistroSqlParser#nestedFunctionArgs}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNestedFunctionArgs(OpenDistroSqlParser.NestedFunctionArgsContext ctx);
	/**
